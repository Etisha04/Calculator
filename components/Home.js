    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <View style={styles.row}>
          <Button onPress={() => setInput("")} backgroundColor="#33fff6">
            AC
          </Button>
          <Button onPress={clear} backgroundColor="#33fff6">
            C
          </Button>
          <Button onPress={percentage} backgroundColor="#33fff6">
            %
          </Button>
          <Button onPress={() => addOperator("/")} backgroundColor="#f8bae9">
            /
          </Button>
        </View>
        <View style={styles.row}>
          ...
          <Button onPress={() => addOperator("x")} backgroundColor="#f8bae9">
            x
          </Button>
        </View>
        <View style={styles.row}>
